...
<span style="color:red">
Questions: <br>
* How do I plot the regression? <br>
</span>
...
data_path = "all.csv" #update for collected data
...
<span style="color:red">
Questions: <br>
* Is there a more specific way I should discuss the comparison between our model and theirs?
</span>
